    ...
    return {
      ...
      link: function(scope, elm, attrs, controller) {
        ...
        scope.init = function(){
          ...
          options.schedulerLicenseKey = "0715571323-fcs-1450419360";
          ...
          jQuery(jQuery(jQuery("td.fc-axis.fc-time.fc-widget-content")[time.getHours()*2]).parents("tr")[0]).css("background", "lightgray");
          //end add more
